...
//ДЗ 21
//При запуске новой игры спрашивайте имена тех, кто будет играть (два человека, например Антон и Лера). Рандомно решайте кто белыми, а кто чёрными. Выводите дату начала партии рядом с таймером. Так же на экране пишите кто ходит в данный момент, Антон или Лера. Все данные так же сохраняем. Создавайте отдельный класс для сохранения данных

//ДЗ 22 СДЕЛАНО
//Доделываем шашки. Делаем что можно бить шашки. У кого не осталось шашек, тот и проиграл. Коротко.


//ДЗ СДЕЛАНО
//В шашках, в настройках сделать пункт из выбора языка. Как минимум должен быть русский и английский. Другие языки по желанию. Локализовать все приложение

//ДЗ
// добавить в результаты шашек результаты матчей (кто с кем играл и за какие шашки (кто черный, кто белый), кто выйграл, дата матча)
//так же добавить кнопку очистить таблицу результов. Использовать CoreData
